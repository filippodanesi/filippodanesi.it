const id = "about.md";
						...
						const data = {title:"About",seo:{title:"About Me",description:"Learn more about the person behind the website and embark on a journey of inspiration and shared experiences.",image:{src:"/about.jpeg",alt:"A human with retrofuturistic gear in retro neon gradient"},pageType:"website"}};
						const _internal = {
							type: 'content',
							filePath: "/Users/filippo/Downloads/dante-astro-theme/src/content/pages/about.md",
							rawData: undefined,
						};
